  ...
  return new Promise((resolve) => {
    resolve(html`
      ...
      <div class="card-text">
        ...
        <p class="text-muted small"><i class="fa fa-info-circle"></i> This screen uses NLP engine to find symptoms in a written text. Evidence found in text will be marked as initial which is important to our engine. All of the identified symptoms will be added to your interview after clicking <span class="badge badge-primary">Next</span>.</p>
      </div>
    `);
  });
};
